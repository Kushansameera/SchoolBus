...
public class DriverSentMessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnBack = (ImageButton)driverSentMessagesFragment.findViewById(R.id.imageButtonBack);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Fragment fragment = new DriverSentContactsFragment();
    ...
    private void deleteMessage(String msgID){
        ref.child("Drivers").child(DriverActivity.userId).child("messages").child("sent").child(msgParentId).child("myMessages").child(msgID).removeValue();
    ...
    private void deleteAllMessage(){
        for(int i=0;i<messages.size();i++){
            ref.child("Drivers").child(DriverActivity.userId).child("messages").child("sent").child(msgParentId).child("myMessages").child(messages.get(i).getMsgID()).removeValue();
